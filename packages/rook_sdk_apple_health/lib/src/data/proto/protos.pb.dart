...
class DataSourceAuthorizerProto extends $pb.GeneratedMessage {
  factory DataSourceAuthorizerProto({
    ...
    if (authorizationUrlIsNull != null) result.authorizationUrlIsNull = authorizationUrlIsNull;
    return result;
  }

  DataSourceAuthorizerProto._();

  factory DataSourceAuthorizerProto.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DataSourceAuthorizerProto.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class DataSourceAuthorizerResultProto extends $pb.GeneratedMessage {
  ...
  factory DataSourceAuthorizerResultProto.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DataSourceAuthorizerResultProto.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class AuthorizedDataSourceV2Proto extends $pb.GeneratedMessage {
  ...
  factory AuthorizedDataSourceV2Proto.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AuthorizedDataSourceV2Proto.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class AuthorizedDataSourceV2ListProto extends $pb.GeneratedMessage {
  ...
  factory AuthorizedDataSourceV2ListProto.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AuthorizedDataSourceV2ListProto.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class AuthorizedDataSourceV2ResultProto extends $pb.GeneratedMessage {
  ...
  factory AuthorizedDataSourceV2ResultProto.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AuthorizedDataSourceV2ResultProto.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
