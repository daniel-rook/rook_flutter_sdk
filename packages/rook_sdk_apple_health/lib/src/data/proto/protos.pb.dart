...
class ResultDailyCaloriesProto extends $pb.GeneratedMessage {
  ...
  factory ResultDailyCaloriesProto.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ResultDailyCaloriesProto.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, ResultDailyCaloriesProto_Result> _ResultDailyCaloriesProto_ResultByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResultDailyCaloriesProto', createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<DailyCaloriesProto>(1, _omitFieldNames ? '' : 'dailyCalories', protoName: 'dailyCalories', subBuilder: DailyCaloriesProto.create)
    ..aOM<PluginExceptionProto>(2, _omitFieldNames ? '' : 'pluginExceptionProto', protoName: 'pluginExceptionProto', subBuilder: PluginExceptionProto.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ResultDailyCaloriesProto clone() => ResultDailyCaloriesProto()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ResultDailyCaloriesProto copyWith(void Function(ResultDailyCaloriesProto) updates) => super.copyWith((message) => updates(message as ResultDailyCaloriesProto)) as ResultDailyCaloriesProto;
  ...
  static $pb.PbList<ResultDailyCaloriesProto> createRepeated() => $pb.PbList<ResultDailyCaloriesProto>();
  @$core.pragma('dart2js:noInline')
  static ResultDailyCaloriesProto getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ResultDailyCaloriesProto>(create);
  static ResultDailyCaloriesProto? _defaultInstance;

  ResultDailyCaloriesProto_Result whichResult() => _ResultDailyCaloriesProto_ResultByTag[$_whichOneof(0)]!;
  void clearResult() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  DailyCaloriesProto get dailyCalories => $_getN(0);
  @$pb.TagNumber(1)
  set dailyCalories(DailyCaloriesProto v) { setField(1, v); }
  @$pb.TagNumber(1)
