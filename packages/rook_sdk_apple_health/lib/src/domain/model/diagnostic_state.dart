...
/// Represents the current state of the Apple Health diagnostic checks.
///
...
/// [permissions] The current status of the required Apple Health permissions.
...
final class AHDiagnosticState {
  final bool isConfigured;
  final bool userIdentified;
  final AHDiagnosticStatePermissions permissions;
  final AHDiagnosticSyncState backgroundSync;
  final AHDiagnosticSyncState manualSync;
  ...
  @override
  String toString() {
    return 'AHDiagnosticState{isConfigured: $isConfigured, userIdentified: $userIdentified, permissions: $permissions, backgroundSync: $backgroundSync, manualSync: $manualSync}';
  }
}
