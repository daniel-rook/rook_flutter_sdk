...
void sleepSummaryTest(
  ...
  group(
      'MethodChannelRookSdkHealthConnect | SleepSummaryResultProto synced unwrap',
      () {
  ...
  group(
      'MethodChannelRookSdkHealthConnect | SleepSummaryResultProto recordsNotFound unwrap',
      () {
    mockMethodCall(channel, (_) async {
