...
void main() {
  group("Mapper", () {
    test(
      ...
      () {
        ...
        expect(result.permissions, HCDiagnosticStatePermissions.requested);
    ...
    test(
      ...
      () {
        ...
        expect(result, HCDiagnosticStatePermissions.none);
      },
    );
  });
  ...
  group("Result", () {
    test("GIVEN success WHEN unwrap THEN return a DiagnosticState", () {
      ...
      expect(result.permissions, HCDiagnosticStatePermissions.granted);
