...
class HealthConnectAvailabilityProto extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, HealthConnectAvailabilityProto> _byValue = $pb.ProtobufEnum.initByValue(values);
  static HealthConnectAvailabilityProto? valueOf($core.int value) => _byValue[value];

  const HealthConnectAvailabilityProto._($core.int v, $core.String n) : super(v, n);
}
...
class BackgroundReadStatusProto extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, BackgroundReadStatusProto> _byValue = $pb.ProtobufEnum.initByValue(values);
