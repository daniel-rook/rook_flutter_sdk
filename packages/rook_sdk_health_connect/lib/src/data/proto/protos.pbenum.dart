...
class HealthConnectAvailabilityProto extends $pb.ProtobufEnum {
  static const HealthConnectAvailabilityProto INSTALLED = HealthConnectAvailabilityProto._(0, _omitEnumNames ? '' : 'INSTALLED');
  static const HealthConnectAvailabilityProto NOT_INSTALLED = HealthConnectAvailabilityProto._(1, _omitEnumNames ? '' : 'NOT_INSTALLED');
  static const HealthConnectAvailabilityProto NOT_SUPPORTED = HealthConnectAvailabilityProto._(2, _omitEnumNames ? '' : 'NOT_SUPPORTED');

  static const $core.List<HealthConnectAvailabilityProto> values = <HealthConnectAvailabilityProto> [
    INSTALLED,
    NOT_INSTALLED,
    NOT_SUPPORTED,
  ];

  static final $core.List<HealthConnectAvailabilityProto?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static HealthConnectAvailabilityProto? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class RequestPermissionsStatusProto extends $pb.ProtobufEnum {
  ...
  static final $core.List<RequestPermissionsStatusProto?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static RequestPermissionsStatusProto? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const RequestPermissionsStatusProto._(super.value, super.name);
}

class BackgroundReadStatusProto extends $pb.ProtobufEnum {
  static const BackgroundReadStatusProto UNAVAILABLE = BackgroundReadStatusProto._(0, _omitEnumNames ? '' : 'UNAVAILABLE');
  static const BackgroundReadStatusProto PERMISSION_NOT_GRANTED = BackgroundReadStatusProto._(1, _omitEnumNames ? '' : 'PERMISSION_NOT_GRANTED');
  static const BackgroundReadStatusProto PERMISSION_GRANTED = BackgroundReadStatusProto._(2, _omitEnumNames ? '' : 'PERMISSION_GRANTED');

  static const $core.List<BackgroundReadStatusProto> values = <BackgroundReadStatusProto> [
    UNAVAILABLE,
    PERMISSION_NOT_GRANTED,
    PERMISSION_GRANTED,
  ];

  static final $core.List<BackgroundReadStatusProto?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static BackgroundReadStatusProto? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
