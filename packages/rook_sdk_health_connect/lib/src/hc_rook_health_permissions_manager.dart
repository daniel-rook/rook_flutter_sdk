...
class HCRookHealthPermissionsManager {
  ...
  @Deprecated(
      "Functions from RookPermissionsManager offer better functionality. Replace with HCRookPermissionsManager.checkHealthConnectAvailability")
  ...
  @Deprecated(
      "Functions from RookPermissionsManager offer better functionality. Replace with HCRookPermissionsManager.openHealthConnectSettings")
