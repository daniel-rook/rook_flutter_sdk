...
class SamsungHealthAvailabilityProto extends $pb.ProtobufEnum {
  ...
  static final $core.List<SamsungHealthAvailabilityProto?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static SamsungHealthAvailabilityProto? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
