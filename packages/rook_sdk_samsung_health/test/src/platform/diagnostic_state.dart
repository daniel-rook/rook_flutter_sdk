...
void diagnosticStateTest(
  ...
  group(
    'MethodChannelRookSdkSamsungHealth | DiagnosticStateResultProto value unwrap',
    () {
  ...
  group(
    'MethodChannelRookSdkSamsungHealth | DiagnosticStateResultProto exception unwrap',
    () {
      mockMethodCall(channel, (_) async {
